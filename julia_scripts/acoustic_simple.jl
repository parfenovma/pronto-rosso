...
# ╔═╡ 4ab03f16-8354-4fed-9776-a815303519bd
using Gridap, Gridap.ReferenceFEs, LinearAlgebra, Plots, PlutoUI, GridapMakie

# ╔═╡ b5f200b5-0d14-4c21-8c35-f80c1110e279
md"config init"

# ╔═╡ 781d5627-e31e-4b1a-b002-453c5d09a7cc
begin
	md"config init"
	Lx = 1.0
	Ly = 1.0
...
# ╔═╡ d0313f54-a018-455d-b59f-7c47f2a187cd
begin
	domain = (0, Lx, 0, Ly)
	partition = (n, n)
...
# ╔═╡ bec70c2e-2e72-49f1-9cfb-6f9d8b788e99
begin
	reffe = ReferenceFE(lagrangian, Float64, 1)
	V = TestFESpace(model, reffe, conformity=:H1, dirichlet_tags="boundary")
end

# ╔═╡ 65e56e6a-3139-4937-a69e-2f1a3756905b
md"Source"

# ╔═╡ 210dbb14-8a96-44ad-9068-32471da31d92
begin 
	σ = 0.05
...
# ╔═╡ 19f636af-0d3a-4fb4-a355-4b2f2f9d4b67
begin
...
# ╔═╡ c432aa92-7567-48e0-86e4-984e69d7e01b
begin
	...
	Vel = copy(get_free_dof_values(V0))  # Текущая скорость
	A = similar(P)  # Ускорение
end

# ╔═╡ 498d9d9b-c9f8-47df-a7cc-b518dcae9e77
...
# ╔═╡ 0ed10ceb-8121-4c46-be39-cb45a7a85252
# Для стабильности используем явную центральную разностную схему
invM = lu(M)  # Факторизация массы для быстрого решения

# ╔═╡ b4dbc396-24c3-4b0f-a0df-09d022459be6
begin
	@bind t Slider(1:length(solutions), default=1)  # solutions — ваш массив полей [p_t1, p_t2, ...]

	# Затем в визуализации:
	mesh!(ax, Ω, color=evaluate(solutions[t], get_cell_points(Ω)), colormap=:viridis)
end

# ╔═╡ b797df06-89a5-4d11-85f7-5414e801b4d9


# ╔═╡ 6e13f313-342b-45da-acc1-6bcd1c357025
...
manifest_format = "2.0"
project_hash = "69805f729a8bf8f6dcf30594f81870a49d29822a"
